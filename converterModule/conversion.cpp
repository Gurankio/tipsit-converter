...
converter::Result::Result(const std::string& output) {
    setOutput(output);
}

std::string converter::Result::getOutput() const {
    return this->output;
}

void converter::Result::setOutput(const std::string &output) {
    this->output = output;
}
...
converter::Result converter::Conversion::convert() {
